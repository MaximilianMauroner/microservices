...
try{console.log(JSON.stringify(await importPostgresToSQLite(handle.client,config.databaseUrl,config.importAllowOverwrite)));}finally{handle.checkpoint();handle.close();}
