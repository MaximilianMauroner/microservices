...
if(config.backend!=="sqlite"||!target||process.env.FIELD_GUIDE_RECOVERY_CONFIRM!=="field-guide-review-recovery")throw new Error("Recovery requires SQLite config, RECOVERY_DATABASE_URL, and FIELD_GUIDE_RECOVERY_CONFIRM=field-guide-review-recovery.");
