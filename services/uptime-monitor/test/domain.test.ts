...
describe("URL safety",()=>{
  ...
  it.each(["0.0.0.0","10.1.2.3","100.64.1.1","127.0.0.1","169.254.1.1","172.16.0.1","192.0.2.1","192.168.1.1","198.18.0.1","198.51.100.1","203.0.113.1","224.0.0.1","255.255.255.255","::","::1","::127.0.0.1","64:ff9b:1::1","100::1","fc00::1","fe80::1","ff02::1","2001:db8::1","3fff::1","5f00::1","::ffff:127.0.0.1"])("blocks reserved address %s",(ip)=>expect(isBlockedAddress(ip)).toBe(true));
