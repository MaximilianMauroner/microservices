...
export type ErrorCode = "dns_failed" | "blocked_address" | "timeout" | "network_error" | "too_many_redirects" | "http_error";
...
export interface HistoryResponse { uptime: number | null; checks: CheckRecord[]; incidents: IncidentRecord[]; buckets: Array<{ at: string; latencyMs: number | null; success: boolean }> }
