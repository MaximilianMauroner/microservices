import { feedbackChoiceDetailsKey, type LocalizedFeedbackForm } from "./domain.js";
...
export function PublicFeedbackPage({ form, submitted, error }: { form: LocalizedFeedbackForm; submitted: boolean; error?: string }) {
  ...
  if (submitted) return <PublicFrame locale={form.locale} wide><FeedbackThankYou de={de} /></PublicFrame>;
