...
export const Route = createFileRoute("/feedback/f/$token")({
  ...
  head: () => ({ meta: [{ title: "Private feedback" }, { name: "robots", content: "noindex, nofollow" }, { name: "referrer", content: "no-referrer" }] }),
...
function PublicRoute() {
  ...
  return <PublicFeedbackPage form={form.form} submitted={search.submitted === true} error={search.error} shareUrl={search.submitted && search.share ? `${form.publicOrigin}/feedback/share/${search.share}` : undefined} shareExpiresAt={search.expires} />;
}
