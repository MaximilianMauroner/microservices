...
export const Route = createFileRoute("/money")({
  ...
  validateSearch: (search: Record<string, unknown>): MoneySearch => ({
    view: search.view === "cash-flow" || search.view === "transactions" || search.view === "investments" || search.view === "accounts" || search.view === "categories" || search.view === "insights" || search.view === "predictions" || search.view === "rules" || search.view === "data" ? search.view : undefined,
