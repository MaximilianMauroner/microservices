...
export const MONEY_CATEGORIES = ["housing", "groceries", "dining", "transport", "shopping", "health", "travel", "subscriptions", "education", "entertainment", "gifts", "taxes", "fees", "cash", "investments", "income", "transfer", "adjustment", "other", "uncategorized"] as const;
