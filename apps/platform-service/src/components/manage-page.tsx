  ...
  return (
    <>
      ...
      <main id="main" className="app-page manage-page">
        <section className="app-heading" aria-labelledby="manage-title"><div><p className="eyebrow">Catalog administration</p><h1 id="manage-title">Manage tools.</h1><p>Cloudflare Access protected · signed in as {initial.actor}. Optimistic concurrency is enabled.</p></div><div className="app-heading__actions"><Badge variant="default">Revision {revision}</Badge><Button type="button" variant="default" size="sm" onClick={() => setSelected("new-entry")}>Add entry</Button><Button type="button" variant="ghost" size="sm" onClick={() => setSelected("new-group")}>Add group</Button></div></section>
