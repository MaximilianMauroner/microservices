...
import type { UploadSummary } from "../../protected-data.js";
      ...
      <main id="main" className="mx-auto w-[min(900px,calc(100%_-_2rem))] py-8 sm:py-10">
        <section className="mb-6 flex flex-col gap-4 border-b pb-6 sm:flex-row sm:items-end sm:justify-between" aria-labelledby="publish-title">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">Upload once, then maintain it from Manage.</p>
          </div>
          <Button nativeButton={false} variant="outline" size="sm" render={<Link to="/manage" preload="intent" />}>
